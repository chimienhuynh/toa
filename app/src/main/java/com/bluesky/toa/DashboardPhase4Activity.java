...
public class DashboardPhase4Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dashboard_phase4);

        Button projectDasboardBtn1 = findViewById(R.id.imageButton4_pdb_jj);
        ...
        projectDasboardBtn1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase4Activity.this, DashBoardActivity.class);
        ...
        projectDasboardBtnEPF.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase4Activity.this, FanProfileActivity.class);
                startActivity(intent);
            }
        });
        ...
        projectDasboardBtnHP.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase4Activity.this, HomePageActivity.class);
                startActivity(intent);
            }
        });
        ...
        projectDasboardBtnVPP.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase4Activity.this, PastProjectActivity.class);
                startActivity(intent);
            }
        });
    }
