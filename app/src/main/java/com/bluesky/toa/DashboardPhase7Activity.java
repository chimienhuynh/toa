...
public class DashboardPhase7Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dashboard_phase7);

        Button projectDasboardBtn1 = findViewById(R.id.imageButton7_pdb_jj);
        ...
        projectDasboardBtn1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase7Activity.this, DashBoardActivity.class);
        ...
        projectDasboardBtnEPF.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase7Activity.this, GuruProfileActivity.class);
                startActivity(intent);
            }
        });
        ...
        projectDasboardBtnHP.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase7Activity.this, HomePageActivity.class);
                startActivity(intent);
            }
        });
        ...
        projectDasboardBtnVPP.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(DashboardPhase7Activity.this, PastProjectActivity.class);
                startActivity(intent);
            }
        });
    }
